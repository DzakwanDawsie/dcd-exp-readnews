...
class ArticleRecycleViewAdapter(private val articles: List<Article>):
    RecyclerView.Adapter<ArticleRecycleViewAdapter.ArticleViewHolder>() {
            ...
            binding.root.setOnClickListener {
                ...
                if (position != RecyclerView.NO_POSITION) {
                    val intent = Intent(binding.root.context, DetailActivity::class.java).apply {
                        ...
                        putExtra("menu", R.id.navigation_home)
                    }
